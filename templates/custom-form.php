	...
	<?php get_template_part('parts/top', 'block'); ?>
        ...
        <div class="form-block">
            ...
            <div class="wrap">
				...
				<form action="https://test.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" class="wpcf7-form">
				<input type=hidden name='captcha_settings' value='{"keyname":"Test","fallback":"true","orgId":"00D5E000000DdtJ","ts":""}'>
				<input type=hidden name="oid" value="00D5E000000DdtJ">
				<input type=hidden name="retURL" value="https://paystra.com/contact-us/">

				<!--  ----------------------------------------------------------------------  -->
				<!--  NOTE: These fields are optional debugging elements. Please uncomment    -->
				<!--  these lines if you wish to test in debug mode.                          -->
				<!--  <input type="hidden" name="debug" value=1>                              -->
				<!--  <input type="hidden" name="debugEmail" value="ovidijusmy@paystra.com">      -->
				<!--  ----------------------------------------------------------------------  -->
				<div class="row">
				...
				<div class="row">
					<span class="wpcf7-form-control-wrap">
						<input required id="phone" type="number" name="phone" value="" size="20" class="wpcf7-form-control wpcf7-text" maxlength="40" aria-invalid="false" placeholder="Phone">
					</span>
					<span class="wpcf7-form-control-wrap">
				...
				<div class="row">
					...
					<span class="wpcf7-form-control-wrap">
						<input required id="fax" type="number" name="fax" value="" size="20" class="wpcf7-form-control wpcf7-text" maxlength="40" aria-invalid="false" placeholder="Fax">
					</span>
				</div>
				<span class="wpcf7-form-control-wrap comments">
				<textarea required id="00N3X00000LmPum" name="00N3X00000LmPum" type="text" wrap="soft" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Comments"></textarea>
				<script>
				CKEDITOR.timestamp = '4.11.2.22';
				var protocolAndHost = window.location.protocol + '//' + window.location.host;

				var editor = CKEDITOR.replace('00N3X00000LmPum', {
				...
				height : '255',
				bodyId : '00N3X00000LmPum_rta_body',
				...
				<input type=hidden id="00D5E000000DdtJ" name="00D5E000000DdtJ" type="checkbox" value="1" />
